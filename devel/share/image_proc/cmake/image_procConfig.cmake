...
if("TRUE" STREQUAL "TRUE")
  set(image_proc_SOURCE_PREFIX /home/smrithi/catkin_workspace/src/image_pipeline/image_proc)
  set(image_proc_DEVEL_PREFIX /home/smrithi/catkin_workspace/devel)
  ...
  set(image_proc_INSTALL_PREFIX /home/smrithi/catkin_workspace/install)
...
if(NOT "/home/smrithi/catkin_workspace/devel/include;/home/smrithi/catkin_workspace/src/image_pipeline/image_proc/include;/usr/include/opencv4 " STREQUAL " ")
  set(image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/smrithi/catkin_workspace/devel/include;/home/smrithi/catkin_workspace/src/image_pipeline/image_proc/include;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/smrithi/catkin_workspace/src/image_pipeline/image_proc/${idir}'.  ${_report}")
    endif()
